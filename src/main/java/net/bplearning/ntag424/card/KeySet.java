...
public class KeySet {
    ...
    // *** Getters and Setters *** //
    public void setKey(int keyNumber, KeyInfo keyInfo) {
        keys[keyNumber] = keyInfo;
    }

    public KeyInfo getKey(int keyNumber) {
        return keys[keyNumber];
    }

    public boolean getUsesLrp() {
        return this.usesLrp;
    }

    public void setUsesLrp(boolean usesLrp) {
        this.usesLrp = usesLrp;
    }

    public int getMacFileKey() {
        return this.macFileKey;
    }

    public void setMacFileKey(int macFileKey) {
        this.macFileKey = macFileKey;
    }
    ...
    public String toString() {
        ...
        sb.append("{");
        sb.append(String.format("LRP:%b, metaKey:%d, macFileKey:%d\n", usesLrp, metaKey, macFileKey));
        sb.append("keys:[\n");
