...
public class KeyInfo {
    ...
    public String toString() {
        ...
        str.append(String.format(", key=0x%s", Hex.encodeHexString(key)));
        str.append(", diversifyKeys=" + diversifyKeys);
        if (this.systemIdentifier.length > 0) {
            str.append(String.format(", SystemIdentifier=%s", Hex.encodeHexString(systemIdentifier)));
        }
        str.append("}");
        return str.toString();
    }
